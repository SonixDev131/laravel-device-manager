...
'inertia.testing.page_paths','inertia.testing.page_extensions','inertia.history.encrypt','web-tinker.path','web-tinker.theme',
'web-tinker.enabled','web-tinker.output_modifier','web-tinker.middleware','web-tinker.config_file','ide-helper.filename',
...
'debugbar.queries.explain','sanctum.csrf-cookie','upload','update','home',
'dashboard','rooms.index','rooms.store','rooms.show','rooms.update',
'rooms.destroy','rooms.computers.store','rooms.commands.publish','rooms.update-agents','rooms.import',
'agents.index','agents.update-all','profile.edit','profile.update',
