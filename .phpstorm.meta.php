...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'app.uploads.disk' => 'string',
            'app.uploads.hash' => 'string',
            ...
            'rabbitmq.port' => 'string',
            'rabbitmq.username' => 'string',
            'rabbitmq.password' => 'string',
            'rabbitmq.vhost' => 'string',
            'rabbitmq.exchanges.direct.name' => 'string',
            'rabbitmq.exchanges.direct.type' => 'string',
            'rabbitmq.exchanges.direct.passive' => 'boolean',
            'rabbitmq.exchanges.direct.durable' => 'boolean',
            'rabbitmq.exchanges.direct.auto_delete' => 'boolean',
            'rabbitmq.exchanges.broadcast.name' => 'string',
            'rabbitmq.exchanges.broadcast.type' => 'string',
            'rabbitmq.exchanges.broadcast.passive' => 'boolean',
            'rabbitmq.exchanges.broadcast.durable' => 'boolean',
            'rabbitmq.exchanges.broadcast.auto_delete' => 'boolean',
            'rabbitmq.consumer.prefetch_count' => 'integer',
            'rabbitmq.consumer.reconnect_delay' => 'integer',
            'rabbitmq.consumer.max_retries' => 'integer',
            'rabbitmq.message.content_type' => 'string',
            'rabbitmq.message.delivery_mode' => 'integer',
            'rabbitmq.command_types.update' => 'string',
            'rabbitmq.command_types.restart' => 'string',
            'rabbitmq.command_types.shutdown' => 'string',
            'rabbitmq.command_types.execute' => 'string',
            'rabbitmq.command_types.status' => 'string',
...
'app.aliases.Vite','app.uploads.disk','app.uploads.hash','auth.defaults.guard','auth.defaults.passwords',
...
'device.commands','filesystems.default','filesystems.disks.local.driver','filesystems.disks.local.root','filesystems.disks.local.serve',
...
'queue.failed.database','queue.failed.table','rabbitmq.host','rabbitmq.port','rabbitmq.username',
'rabbitmq.password','rabbitmq.vhost','rabbitmq.exchanges.direct.name','rabbitmq.exchanges.direct.type','rabbitmq.exchanges.direct.passive',
'rabbitmq.exchanges.direct.durable','rabbitmq.exchanges.direct.auto_delete','rabbitmq.exchanges.broadcast.name','rabbitmq.exchanges.broadcast.type','rabbitmq.exchanges.broadcast.passive',
'rabbitmq.exchanges.broadcast.durable','rabbitmq.exchanges.broadcast.auto_delete','rabbitmq.consumer.prefetch_count','rabbitmq.consumer.reconnect_delay','rabbitmq.consumer.max_retries',
'rabbitmq.message.content_type','rabbitmq.message.delivery_mode','rabbitmq.command_types.update','rabbitmq.command_types.restart','rabbitmq.command_types.shutdown',
'rabbitmq.command_types.execute','rabbitmq.command_types.status','sanctum.stateful','sanctum.guard','sanctum.expiration',
...
'inertia.testing.page_paths','inertia.testing.page_extensions','inertia.history.encrypt','permission.models.permission','permission.models.role',
...
'permission.cache.store','web-tinker.path','web-tinker.theme','web-tinker.enabled','web-tinker.output_modifier',
'web-tinker.middleware','web-tinker.config_file','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename',
...
'version','update','installer','command-result',
'home','dashboard','rooms.index','rooms.store','rooms.show',
'rooms.update','rooms.destroy','rooms.computers.store','rooms.commands.publish','rooms.commands.index',
'rooms.blocked-websites.index','rooms.update-agents','rooms.import','agents.index','agents.update-all',
'agents.upload-package','agents.packages.delete','agents.upload-installer','agents.installers.broadcast','agents.installers.delete','profile.edit','profile.update','profile.destroy','password.edit',
...
'pagination::tailwind','web-tinker::web-tinker',);
...
'DEBUGBAR_OPEN_STORAGE','HASH_ALGORITHM',);
