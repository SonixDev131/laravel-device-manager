...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            'App\Services\RabbitMQ\RabbitMQConfigInterface' => \App\Services\RabbitMQ\RabbitMQConfig::class,
            ...
            'rabbitmq.consumer' => \iamfarhad\LaravelRabbitMQ\Consumer::class,
    ...
    override(\config(), map([
            ...
            'queue.connections.rabbitmq.hosts.host' => 'string',
            'queue.connections.rabbitmq.hosts.port' => 'string',
            'queue.connections.rabbitmq.hosts.user' => 'string',
            'queue.connections.rabbitmq.hosts.password' => 'string',
            'queue.connections.rabbitmq.hosts.vhost' => 'string',
            'queue.connections.rabbitmq.hosts.lazy' => 'boolean',
            'queue.connections.rabbitmq.hosts.keepalive' => 'boolean',
            'queue.connections.rabbitmq.hosts.heartbeat' => 'integer',
            'queue.connections.rabbitmq.hosts.secure' => 'boolean',
            ...
            'queue.connections.rabbitmq.options.queue.qos.prefetch_size' => 'integer',
            'queue.connections.rabbitmq.options.queue.qos.prefetch_count' => 'integer',
            'queue.connections.rabbitmq.options.queue.qos.global' => 'boolean',
            ...
            'rabbitmq.connection.host' => 'string',
            'rabbitmq.connection.port' => 'integer',
            'rabbitmq.connection.user' => 'string',
            'rabbitmq.connection.password' => 'string',
            'rabbitmq.connection.vhost' => 'string',
            'rabbitmq.exchanges.commands.name' => 'string',
            'rabbitmq.exchanges.commands.type' => 'string',
            'rabbitmq.exchanges.commands.durable' => 'boolean',
            'rabbitmq.exchanges.commands.auto_delete' => 'boolean',
            'rabbitmq.exchanges.commands.passive' => 'boolean',
            'rabbitmq.exchanges.status.name' => 'string',
            'rabbitmq.exchanges.status.type' => 'string',
            'rabbitmq.exchanges.status.durable' => 'boolean',
            'rabbitmq.exchanges.status.auto_delete' => 'boolean',
            'rabbitmq.exchanges.status.passive' => 'boolean',
            'rabbitmq.queues.computer_status' => 'string',
            'rabbitmq.queues.computer_commands' => 'string',
            'rabbitmq.routing_keys.command_computer' => 'string',
            'rabbitmq.routing_keys.command_room_broadcast' => 'string',
            'rabbitmq.routing_keys.status_updates' => 'string',
            'rabbitmq.consumer.prefetch_count' => 'integer',
            'rabbitmq.consumer.timeout' => 'integer',
...
'debugbar.route_domain','debugbar.theme','debugbar.debug_backtrace_limit','device.commands','filesystems.default',
...
'queue.connections.rabbitmq.driver','queue.connections.rabbitmq.queue','queue.connections.rabbitmq.hosts.host','queue.connections.rabbitmq.hosts.port','queue.connections.rabbitmq.hosts.user',
'queue.connections.rabbitmq.hosts.password','queue.connections.rabbitmq.hosts.vhost','queue.connections.rabbitmq.hosts.lazy','queue.connections.rabbitmq.hosts.keepalive','queue.connections.rabbitmq.hosts.heartbeat',
'queue.connections.rabbitmq.hosts.secure','queue.connections.rabbitmq.options.ssl_options.cafile','queue.connections.rabbitmq.options.ssl_options.local_cert','queue.connections.rabbitmq.options.ssl_options.local_key','queue.connections.rabbitmq.options.ssl_options.verify_peer',
'queue.connections.rabbitmq.options.ssl_options.passphrase','queue.connections.rabbitmq.options.queue.job','queue.connections.rabbitmq.options.queue.qos.prefetch_size','queue.connections.rabbitmq.options.queue.qos.prefetch_count','queue.connections.rabbitmq.options.queue.qos.global',
'queue.batching.database','queue.batching.table','queue.failed.driver','queue.failed.database','queue.failed.table',
'rabbitmq.connection.host','rabbitmq.connection.port','rabbitmq.connection.user','rabbitmq.connection.password','rabbitmq.connection.vhost',
'rabbitmq.exchanges.commands.name','rabbitmq.exchanges.commands.type','rabbitmq.exchanges.commands.durable','rabbitmq.exchanges.commands.auto_delete','rabbitmq.exchanges.commands.passive',
'rabbitmq.exchanges.status.name','rabbitmq.exchanges.status.type','rabbitmq.exchanges.status.durable','rabbitmq.exchanges.status.auto_delete','rabbitmq.exchanges.status.passive',
'rabbitmq.queues.computer_status','rabbitmq.queues.computer_commands','rabbitmq.routing_keys.command_computer','rabbitmq.routing_keys.command_room_broadcast','rabbitmq.routing_keys.status_updates',
'rabbitmq.consumer.prefetch_count','rabbitmq.consumer.timeout','sanctum.stateful','sanctum.guard','sanctum.expiration',
...
'dashboard','rooms.index','rooms.store','rooms.show','rooms.update',
'rooms.destroy','rooms.computers.store','rooms.commands.dispatch','rooms.import',
...
'DB_PASSWORD','RABBITMQ_HOST','RABBITMQ_PORT','RABBITMQ_USER','RABBITMQ_PASSWORD',
'RABBITMQ_VHOST','SESSION_DRIVER','SESSION_LIFETIME','SESSION_ENCRYPT','SESSION_PATH',
...
'AWS_DEFAULT_REGION','AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','DEBUGBAR_ENABLED',
