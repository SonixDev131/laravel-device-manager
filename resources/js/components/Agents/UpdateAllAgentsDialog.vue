...
const handleSubmit = async () => {
    ...
    try {
        const response = await axios.post('/agents/update-all', form.data());
...
<template>
    <Dialog :open="open" @update:open="open = $event">
        <DialogTrigger as-child>
            <Button variant="default" class="bg-blue-600 hover:bg-blue-700"> Update All Agents System-wide </Button>
        </DialogTrigger>

        <DialogContent class="sm:max-w-[425px]">
            <DialogHeader>
                <DialogTitle>Update All Agents System-wide</DialogTitle>
                <DialogDescription>
                    This will update ALL agents across ALL rooms in the system. Only administrators can perform this action.
                </DialogDescription>
            </DialogHeader>
            ...
            <form @submit.prevent="handleSubmit" class="mt-4 space-y-4">
                ...
                <Alert v-if="responseMessage" :class="isSuccess ? 'border-green-200 bg-green-50' : 'border-red-200 bg-red-50'">
                ...
                <DialogFooter>
                    ...
                    <Button type="submit" :disabled="isLoading" class="bg-blue-600 hover:bg-blue-700">
                        ...
                        {{ isLoading ? 'Updating...' : 'Update All Agents' }}
                    </Button>
                </DialogFooter>
            </form>
        </DialogContent>
